...
//     <div
//       ref={dropdownRef}
//       className="origin-top-right absolute mt-2 w-48 rounded-md shadow-lg bg-card ring-1 ring-border ring-opacity-5 z-50"
//       style={{ top: position.top, left: position.left }}
//     >
//       <div className="py-1" role="menu" aria-orientation="vertical">
//         <button
//           onClick={() => {
//             onEditProject(project._id, project);
//             onClose();
//           }}
...
//         <button
//           onClick={() => {
//             handleTimesheetNavigation(project);
//             onClose();
//           }}
//           className="w-full text-left px-4 py-2 text-sm text-foreground hover:bg-muted flex items-center gap-3"
//           role="menuitem"
...
//       </div>
//     </div>,
//     document.body // Render the menu into the body tag
//   );
// };
// // END: NEW COMPONENT
...
//       setMenuData(null); // Close if already open
//     } else {
//       setMenuData({
//         project,
//         position: {
//           top: rect.bottom + window.scrollY,
//           left: rect.left + window.scrollX - 150, // Adjust left position to align
//         },
//       });
//     }
//   };
...
//                       className="p-2 rounded-full hover:bg-muted focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-background focus:ring-primary"
//                     >
//                       <FiMoreVertical />
//                     </button>
//                   </td>
...
// Projects.tsx - Combined ProjectsView + AddTaskModal (fixed duplicate imports & exports)
import React, { useState, useMemo, useEffect, useRef } from "react";
