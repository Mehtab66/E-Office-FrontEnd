...
//             </div>
//             <span
//               className={`px-3 py-1 text-xs font-medium rounded-full ${deliverable.status === "approved"
//                 ? "bg-green-100 text-green-800"
...
//                     <span
//                       className={`px-2 py-1 text-xs font-medium rounded-full ${entry.approved ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"
//                         }`}
//                     >
    ...
    <div className="p-4 sm:p-6 space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
        <div className="flex justify-between items-start flex-wrap gap-3">
          ...
          <span
            className={`px-3 py-1 text-sm font-medium rounded-full ${project.status === "active"
                ? "bg-green-100 text-green-800"
                : project.status === "pending"
                  ? "bg-amber-100 text-amber-800"
                  : "bg-gray-100 text-gray-800"
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {timesheets.map((entry: any, idx: number) => (
                  <tr key={entry._id || entry.id || `local-${idx}`}>
                    ...
                    <td className="px-4 py-4 whitespace-nowrap">
                      <span
                        className={`px-2 py-1 text-xs font-medium rounded-full ${entry.approved
                            ? "bg-green-100 text-green-800"
